...
1. Start **Gate 8**: diagnostics / maintenance / performance — health overview, startup timeline, provider
   latency and quota observations, process ownership plus orphan detection, database health and
   compaction with safety copy, sanitized diagnostics export, and issue-report drafting.

...
| `HEAD` | `594b8b4` | 2026-09-18 | R0 | R0 sweep complete: 26/26 dispositions final + breadcrumbs (this commit) | docs only | engine full **931 passed, 10 subtests**; desktop tsc 0, vitest 93 | none | no | — | no | no | LOW | corpus rows SEC-01 / TR-01 / TR-02 / APR-05 / APR-06 / COR-03 / COR-06 / THM-01 / ERR-01; `increments/R0-SWEEP.md`; A-20 | REL-01 remains `OPEN_RELEASE_BLOCKER` until R8; 26-vs-27 row count left for Campaign B |

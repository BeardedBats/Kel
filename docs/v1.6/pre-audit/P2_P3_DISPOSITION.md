...
| APR-03 | `_memory_check_queue` is instance state — queued memory checks lost on restart | P2 | `13_PHASE3_DELTA_AUDIT.md` | OPEN (sweep pending) | — | restart regression | TBD | pending |

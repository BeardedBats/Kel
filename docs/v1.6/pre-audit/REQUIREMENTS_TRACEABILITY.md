...
| REQ-P2P3 | audit docket + sprint §40 | P2/P3 sweep | in progress — 6/27 rows dispositioned with inline evidence (P2 0/10, P3 6/17); the rest stay `OPEN (sweep pending)` | — | — | P2_P3_DISPOSITION.md | pending |

...
| Mobile Ramble vetting preview | Mobile sheet `299:12871` | The frame shows populated requirements and decisions. A real isolated vetting session and preview are needed before mapping its content and actions; sample answers must not be hard-coded. | `transcription/index.tsx` |

...
next_item: Desktop first: implement the remaining Ramble capture/API/merge/vetting, setup, Kibble, and other desktop frames/variants. Current startup, stopped-engine, diagnostics, update, and delete views have source evidence and await a larger milestone package. Keep mobile paused and canonical App at 8c67121 until broader desktop completion. Pet enable needs Nick’s policy decision; diagnostics maintenance needs matching engine operations.

...
next_item: Complete desktop implementation first. Finish the desktop Memory review (273:8389), Permission menu (273:9098), Slash menu (273:9737), and Attach menu (273:9951) batch. Then close populated Work, Permissions, Projects, and Scheduled tasks with bounded engine states. Pet enable remains locked pending Nick's V1.6 policy decision. Diagnostics maintenance needs matching runtime operations. Keep mobile paused. Update canonical App after desktop completion, then resume mobile UI/UX.

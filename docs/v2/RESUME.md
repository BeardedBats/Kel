...
**Next item:** compare chat Permission `299:12418` with a runtime-capable isolated conversation. Mobile Projects, Work empty state, Activity running state, and Permissions empty state now have scoped checks. Mobile Kibble placement awaits Nick's answer; keep its existing route. Continue remaining components and V2-18/19 acceptance before App promotion.

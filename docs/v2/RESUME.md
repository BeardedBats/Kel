...
**Next item:** apply Nick's decision to put mobile Kibble under Settings → Tools and use Figma's four-tab bar. Then compare chat Permission `299:12418` with runtime-capable options. Mobile Projects, Work, Activity, Permissions, and populated Knowledge have scoped checks. Continue remaining components and V2-18/19 acceptance before App promotion.

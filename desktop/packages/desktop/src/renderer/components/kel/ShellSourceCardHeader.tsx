...
const TITLES = ['Available now', 'Custom models', 'Jobs', 'Waiting to continue', 'Team assignments', 'Active permissions', 'Access requests', 'Permission check', 'Knowledge', 'Project map', 'Recipes', 'Integrations', 'Readiness preflight', 'Credential metadata', 'Health', 'Measured performance', 'Maintenance', 'Kel', 'Archived', 'Kel runs on this machine', 'Connect a model', 'Where work happens', 'How much Kel does on its own', "You're set"];
